package ch.landrus.minecraft.tutorialmod.client;
...
public class PowergenScreen extends AbstractContainerScreen<PowergenContainer> {
    ...
    private final ResourceLocation GUI = new ResourceLocation(TutorialMod.MOD_ID, "textures/gui/powergen_gui.png");
